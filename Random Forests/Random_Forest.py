...
Diabetes = pd.read_csv("C:\\EXCELR\\NOTES WRITTEN\\SOLVING_ASSIGNMENTS\\RANDOM_FOREST\\Diabetes_RF.csv")
Diabetes.head()
Diabetes.columns
...
print("Accuracy",(497+264)/(497+264+4+3)*100)#Accuracy 99.08854166666666

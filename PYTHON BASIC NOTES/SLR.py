...
wcat=pd.read_csv("C:\\Users\\madis\\Downloads\\Simple Linear Regression-20180920T054749Z-001\\Simple Linear Regression\\wc-at.csv")
wcat.columns

plt.hist(wcat.Waist)
plt.boxplot(wcat.Waist)
plt.boxplot(wcat.Waist,0,"rs",1)

...
''.join(x for x in 'make IT camel CaSe'.title())
'Make It Camel Case'
...
Bc =open("C:\\Users\\UX009405\\Desktop\\ANAND.csv","r")
print(Bc.read())

Bp =open("C://Users//UX009405//Desktop//ANAND.csv","r")
print(Bp.readline())

Bp =open("C://Users//UX009405//Desktop//ANAND.csv","r")
print(Bp.readlines())

Bs =open("C://Users//UX009405//Desktop//ANAND.csv","r")
print(Bs.read(10))

# os package used to delete a file from the local drive
import os
os.remove("C://Users//UX009405//Desktop//ANAND.csv")

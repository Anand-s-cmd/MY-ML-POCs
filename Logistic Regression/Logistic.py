...
temp = claimants.drop(["CASENUM"],axis=1,inplace=True)
...
print(metrics.accuracy_score(y,y_pred))# CALCULATING THE ACCURACY
print(metrics.recall_score(y,y_pred))# CALCULATING THE SENSITIVITY OR TPR OR RECALL
